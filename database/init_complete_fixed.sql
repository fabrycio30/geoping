-- =====================================================
-- GeoPing v2.0 - Schema Completo (CORRIGIDO)
-- =====================================================

-- Schema original (mantém dados existentes)
...
CREATE INDEX IF NOT EXISTS idx_conversations_uuid ON conversations(conversation_id);
